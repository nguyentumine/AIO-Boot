...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (Gentoo 4.9.3 p1.5, pie-0.6.4) 4.9.3'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=I386_EFI -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/4.9.3/include -I$(top_srcdir)/include -I$(top_builddir)/include'

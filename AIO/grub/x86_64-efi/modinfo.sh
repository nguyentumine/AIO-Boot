...
grub_target_cc_version='gcc-8 (Ubuntu 8.4.0-1ubuntu1~18.04) 8.4.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/8/include -I$(top_srcdir)/include -I$(top_builddir)/include'
